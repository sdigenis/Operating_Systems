...
#define OUTPUT(o, p, q) (printf("%s%s/%d/%lldms - \tExpB: %lf \tLExpB: %lf  %s\n", (o), (p)->thread_info->processName, (p)->time_slice, TICKS_TO_MS(clocktick), (p)->exp_burst, (p)->last_exp_burst, (q)))
